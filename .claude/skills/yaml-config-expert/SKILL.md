---
name: yaml-config-expert
description: Structural YAML for Kubernetes, Helm, Compose, GitHub Actions, and similar config with validation and review discipline.
license: MIT
compatibility: Claude Code skills; Vipecoding submodule pack.
metadata:
  skillId: yaml-config-expert
  role: devops-sre
  version: "1.0"
---
