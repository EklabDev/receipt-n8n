...
license: MIT
compatibility: Cursor rules/skills; submodule pack.
metadata:
...
Invoke before any change that touches credentials, customer data, dependencies, or compliance-sensitive areas.
