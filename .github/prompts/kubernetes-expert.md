# Prompt: kubernetes-expert

**Skill id:** `kubernetes-expert`

Kubernetes workloads, networking, RBAC, policies, rollouts, and operational safety beyond a single manifest tweak.
