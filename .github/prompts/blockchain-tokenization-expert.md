# Prompt: blockchain-tokenization-expert

**Skill id:** `blockchain-tokenization-expert`

Token standards (e.g. ERC-20/721/1155), issuance workflows, custody vs non-custody models, upgrades, and regulatory-aware design checkpoints.
