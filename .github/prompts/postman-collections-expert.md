# Prompt: postman-collections-expert

**Skill id:** `postman-collections-expert`

Postman Collection v2.1 authoring, environments, scripts, OpenAPI alignment, and safe reading of exported collection JSON.
